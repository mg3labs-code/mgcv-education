...
import { blockToLayer, LAYERS } from "@/lib/sevenLayers";
import { synthesizeLayerBlock } from "@/lib/synthesizeLayerBlock";
  ...
  const navBlocks = useMemo(() => {
    ...
    for (const layer of LAYERS) {
      ...
      if (idx >= 0) {
        ...
        picked.push(synthesizeLayerBlock(layer, topic));
      }
    }
    return picked;
  }, [allBlocks, isSevenLayerMode, episode?.title]);
