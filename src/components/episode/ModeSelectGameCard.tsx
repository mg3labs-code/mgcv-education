            ...
            return (
              <motion.button
                ...
                animate={{
                  ...
                  y: isPicked ? -20 : 0,
                  rotate: isHover && !isPicked ? 0 : tiltBase,
                  scale: isPicked ? 1.06 : isHover ? 1.03 : 1,
                }}
                transition={{
                  duration: 0.45,
                  delay: 0.1 + i * 0.1,
                ...
                whileTap={{ scale: 0.97 }}
                className="group relative text-left rounded-3xl p-[2px] cursor-pointer"
                style={{
                  boxShadow: isHover
              ...
              >
                {/* Gradient frame */}
                <div
                  className={`absolute inset-0 rounded-3xl bg-gradient-to-br ${m.gradient} opacity-80 group-hover:opacity-100 transition-opacity`}
                />
                {/* Inner card */}
                <div
                  className="relative rounded-[22px] px-5 py-6 h-full min-h-[280px] flex flex-col"
                  style={{
                    background:
