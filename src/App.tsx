...
const TeacherQuestionBank = lazy(() => import("./pages/TeacherQuestionBank"));
          ...
          <ErrorBoundary>
            ...
            <Suspense fallback={<PageLoader />}>
              <Routes>
                ...
                <Route path="/previews" element={<PreviewMockups />} />
                <Route path="/previews/:slug" element={<PreviewMockups />} />
                ...
                <Route path="/teacher/question-bank" element={<ProtectedRoute><TeacherQuestionBank /></ProtectedRoute>} />
